...
class ApiCollection extends \Phalcon\Mvc\Micro\Collection implements MountableInterface, CollectionInterface
{
    ...
    public static function factory($prefix, $name = null)
    {
        ...
        /** @var \Prest\Api\ApiCollection $collection */
     ...
     *
     * @param \Prest\Api\ApiEndpoint $endpoint Endpoint to mount (shortcut for endpoint function)
     *
     * @return static
     */
     ...
     * Mounts endpoint to the collection
     *
     * @param \Prest\Api\ApiEndpoint $endpoint Endpoint to mount
     *
     * @return static
     */
    ...
    /**
     * @return \Prest\Api\ApiEndpoint[] Array of all mounted endpoints
     */
     ...
     *
     * @return \Prest\Api\ApiEndpoint|null Endpoint with the given name
     */
